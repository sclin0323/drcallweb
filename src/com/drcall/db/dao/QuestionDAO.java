 ...
 * 
 * @see com.drcall.db.dao.Question
...
public class QuestionDAO extends HibernateDaoSupport {
	...
	public List<Question> findByExample(Question instance) {
		...
		try {
			List<Question> results = (List<Question>) getHibernateTemplate()
	...
	public List<Question> findByContent(Object content) {
		return findByProperty(CONTENT, content);
	}

	public List<Question> findByActive(Object active) {
